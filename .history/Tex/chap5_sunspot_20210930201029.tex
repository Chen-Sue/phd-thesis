...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ccccc}
    ...
    4 & 72-[64(LSTM)-32(LSTM)-16(Conv)]-72 & 0.0107 & 0.1036 \\
      ...
      & 72-[512(LSTM)-256(LSTM)-128(Conv)]-72 & 0.0061 & 0.0779 \\
      & 132-[64(LSTM)-32(LSTM)-16(Conv)]-72  \\
      & 132-[128(LSTM)-64(LSTM)-32(Conv)]-72  \\
    ...
    \hline
    5 & 72-[128(LSTM)-64(LSTM)-32(LSTM)-21(Conv)]-72 & 0.0061 & 0.0779 \\
      & 72-[256(LSTM)-128(LSTM)-64(LSTM)-42(Conv)]-72 & 0.0105 & 0.1023 \\
      & 72-[512(LSTM)-256(LSTM)-128(LSTM)-85(Conv)]-72 & 0.0061 & 0.0779 \\
