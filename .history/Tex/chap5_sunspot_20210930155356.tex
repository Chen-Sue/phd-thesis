...
\begin{table}[!htbp]
  \centering
  \bicaption{输入时间窗口为72的最佳模型预测2021年9月的太阳黑子强度。}{Prediction the sunspot amplitudes by the best models with 72 time windows in September 2021.}
  \label{tab:ss_in_72_out_1}
  \footnotesize
  \begin{tabular}{ccccc}
    \toprule
    太阳黑子强度 & LSTM-RNN & 1DCNN & LSTM-1DCNN  \\
    \midrule
    数量 & 37.925 & 31.660934 & 41.15491\\
    面积 & & \\
    \bottomrule
\end{tabular}
\end{table}
