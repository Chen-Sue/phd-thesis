...
地震目录来自南加州地震数据中心（Southern California Earthquake Data Center，简称SCEDC）\footnote{\href{https://service.scedc.caltech.edu/ftp/catalogs/}{https://service.scedc.caltech.edu/ftp/catalogs/}}，记录从1932年1月1日开始记录，2021年9月19日截至，在研究区域中一共有831906条数据。每条记录包含以下信息：
\begin{itemize}
