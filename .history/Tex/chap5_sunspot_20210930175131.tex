...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ccccc}
    ...
    \hline
    5 & 72-[128(LSTM)-64(LSTM)-32(LSTM)-16(Conv)]-72 &  &  \\
      & 72-[256(LSTM)-128(LSTM)-64(LSTM)-32(Conv)]-72 &  &  \\
      & 72-[512(LSTM)-256(LSTM)-128(LSTM)-64(Conv)]-72 &  &  \\
      & 132-[128(LSTM)-64(LSTM)-32(LSTM)-16(Conv)]-72 &  &  \\
      & 132-[256(LSTM)-128(LSTM)-64(LSTM)-32(Conv)]-72 &  &  \\
      & 132-[512(LSTM)-256(LSTM)-128(LSTM)-64(Conv)]-72 &  &  \\
      & 264-[128(LSTM)-64(LSTM)-32(LSTM)-16(Conv)]-72 &  &  \\
      & 264-[256(LSTM)-128(LSTM)-64(LSTM)-32(Conv)]-72 &  &  \\
      & 264-[512(LSTM)-256(LSTM)-128(LSTM)-64(Conv)]-72 &  &  \\
    \bottomrule
  \end{tabular}
\end{table}
