...
地震目录基本不存在噪音。尽管几十年前地震目录是人工记录的，可能会存在误记或漏记（尤其是小震）。而且几十年前的地震仪对小震反应可能不灵敏，小震也可能被忽视。当然，小震不是关注的重点。还有一方面的噪音来自人工地震的影响。人工地震是由人类活动引起的地震，主要有炸药震源（如工地爆破、地下核爆破等）、非炸药震源（如气爆震源、电能震源、大型水库等）。
