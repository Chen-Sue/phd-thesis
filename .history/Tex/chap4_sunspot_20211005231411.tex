...
\begin{table}[!htbp]
  \centering
  \bicaption{测试阶段不同模型、不同输入时间窗口预测未来1个月太阳黑子面积的效果指标。}{The indicators for predicting the next monthly sunspot areas by different models with different input windows for testing stage.}
