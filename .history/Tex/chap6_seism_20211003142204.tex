...
\begin{table}[!htbp]
  \bicaption{不同模型预测整个区块未来十年最大震级的拟合指标效果。}{The metrics for predicting the maximum magnitute in next ten years by different models.}
...
\begin{table}[!htbp]
  \bicaption{不同模型预报整个区块未来十年最大震级的拟合指标效果（数据集划分比例为0.9：0.1）。}{The metrics for predicting the maximum magnitute with the split ratio 0.9:0.1 in next 10 year by different models.}
