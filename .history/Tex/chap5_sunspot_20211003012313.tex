...
本研究使用了LSTM-RNN、1DCNN以及LSTM-1DCNN预测未来太阳黑子变化，采用了MSSN和MSSA数据集，发现第25太阳周，利用具有5层LSTM-1DCNN预测的最大太阳黑子数为132.8636（发生在2024年12月），利用4层的预测的最大太阳黑子面积为1469.0072（发生在2025年3月）。预测结果与\citet{covas2019neural}的研究结果不仅在黑子强度上类似，而且在发生时间上也相近。
