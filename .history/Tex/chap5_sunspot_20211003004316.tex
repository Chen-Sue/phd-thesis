...
\begin{equation}
  ...
  S(t,t+\Delta,\ldots,t+n\Delta)=S[P(t-\Delta t),S(t-2\Delta t),\ldots,S(t-m\Delta t)].
\end{equation}
其中，$\Delta t$代表样本的采样间隔（1个月）。$S(t,t+\Delta t,\ldots,t+n\Delta t)$代表预测未来$n$个月的太阳黑子强度，$S(t-\Delta t),S(t-2\Delta t),\ldots,S(t-m\Delta)$代表历史$m$个月的太阳黑子强度。
