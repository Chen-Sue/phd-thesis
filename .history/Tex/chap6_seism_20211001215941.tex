...
\begin{subfigure}[b]{0.5\textwidth}
    \caption{KNN}
    \vspace{-0.1cm}
    \includegraphics[width=\textwidth]{Img/chap6_seism/block1/seism_knn_minyear_1932_maxyear_2021_spanlat_2_spanlon_4_timewindow_72_nextmonth_12_minmag_3.0_block_1.pdf}
