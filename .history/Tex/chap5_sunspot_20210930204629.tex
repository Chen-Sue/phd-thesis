...
\begin{table}[!htbp]
\centering
\bicaption{最佳模型预测72个月的太阳黑子强度。}{Prediction the sunspot amplitudes by the best models in September 2021.}
\label{tab:ss_out_1}
\footnotesize
\begin{tabular}{cccccc}
    \toprule
    日期 & 太阳黑子强度 & 输入时间窗口 & 3 & 1DCNN & LSTM-1DCNN  \\
    \midrule
    未来72个月 & 最大数量 & 264个月 & 151.5516 & 174.7100（2024年12月） & 132.8636（2025年1月） \\
     & 最大面积 & 个月 & 2025年4月 \\
    \bottomrule
\end{tabular}
\end{table}
