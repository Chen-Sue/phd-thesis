...
当输入时间窗口为72个月$I_{-3}$时，随机森林拟合指标为MSE$=\SI{0.0010}{m^{3}/s}$, RMSE$=\SI{0.0313}{m^{3}/s}$，预测2019年1月的泉流量为$\SI{2.9852}{m^{3}/s}$；当输入时间窗口为四个月$I_{-4}$时，随机森林拟合指标为MSE$=\SI{0.0010}{m^{3}/s}$, RMSE$=\SI{0.0319}{m^{3}/s}$，预测2019年1月的泉流量为$\SI{2.9945}{m^{3}/s}$；当输入时间窗口为五个月$I_{-5}$时，随机森林拟合指标为MSE$=\SI{0.0010}{m^{3}/s}$, RMSE$=\SI{0.0317}{m^{3}/s}$，预测2019年1月的泉流量为$\SI{3.0106}{m^{3}/s}$；当输入时间窗口为六个月$I_{-6}$时，随机森林拟合指标为MSE$=\SI{0.0011}{m^{3}/s}$, RMSE$=\SI{0.0325}{m^{3}/s}$，预测2019年1月的泉流量为$\SI{3.0515}{m^{3}/s}$。
