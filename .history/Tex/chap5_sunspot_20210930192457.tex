...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}[b]{1.0\textwidth}
    ...
    \vspace{-0.35cm}
    \includegraphics[width=\textwidth]{Img/chap5_ss/ssn_series_in_264_out_72_layer_5_layersize_128_lstm_cnn.pdf}
    \label{fig:ssn_series_in_264_out_72_layer_5_layersize_128_lstm_cnn}
    \end{subfigure}
  \vspace{-2cm}
