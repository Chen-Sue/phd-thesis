...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \vspace{-1cm}
  \bicaption[$b$值计算的两种方法]{$b$值计算的两种方法。（a）1932年至2021年期间不同起算震级下利用MLE计算的$b$值；（b）1932年至2021年期间Gutenberg-Richter关系式$\log N=a-bM$。}{(a) The methods of the calculating $b$ value. The $b$ value calculated by MLE between 1932 and 2021; (b) The Gutenberg-Richter relation $\log N=a-bM$ between 1932 and 2021.}
