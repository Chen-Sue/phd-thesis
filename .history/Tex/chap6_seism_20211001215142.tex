...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}[b]{0.4\textwidth}
      \caption{$\log N=a-bM$}
      \includegraphics[width=\textwidth]{Img/chap6_seism/seism_lstm_minyear_1932_maxyear_2021_spanlat_2_spanlon_4_timewindow_72_nextmonth_12_minmag_3.pdf}
      \label{fig:seism_lstm_minyear_1932_maxyear_2021_spanlat_2_spanlon_4_timewindow_72_nextmonth_12_minmag_3}
  \end{subfigure}
  \vspace{-1cm}
  \bicaption{（a）1932年至2021年期间不同起算震级下利用MLE计算的$b$值；（b）1932年至2021年期间Gutenberg-Richter关系式$\log N=a-bM$。}{(a) The $b$ value calculated by MLE between 1932 and 2021; (b) The Gutenberg-Richter relation $\log N=a-bM$ between 1932 and 2021.}
  \label{fig:seism_mc_1932_2021}
