...
\begin{equation}
  ...
  S(t+\Delta,t+2\Delta,\ldots,t+n\Delta)=S[P(t),S(t-\Delta),\ldots,S(t-(m-1)\Delta)].
\end{equation}
其中，$\Delta t$代表样本的采样间隔（1个月）。$S(t+\Delta,t+2\Delta,\ldots,t+n\Delta)$代表未来$n$个月的太阳黑子强度，$S(t-\Delta),S(t-2\Delta),\ldots,S(t-m\Delta)$代表历史$m$个月的太阳黑子强度。
