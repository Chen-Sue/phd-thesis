...
\subsection{表和图}\label{sec:seis_table}

{\footnotesize
\begin{longtable}{cclcccccccc}
  \bicaption[不同模型基于区块2至区块6预测未来1年最大震级的拟合指标效果（数据集划分比例为0.8：0.2）]{不同模型基于区块2至区块6预测未来1年最大震级的拟合指标效果（数据集划分比例为0.8：0.2）。}{The metrics for predicting the maximum magnitute from block 2 to block 6 with the split ratio 0.8:0.2 in next year by different models.}
  \label{tab:seism_block} \\
  \toprule
  \multirow{2}*{区块号} & \multirow{2}*{模型} & \multicolumn{2}{c}{训练集} & \multicolumn{2}{c}{测试集} \\
  \cmidrule(lr){3-4} \cmidrule(lr){5-6} \noalign{\smallskip}
  & & MSE & RMSE & MSE & RMSE \\
  \midrule
  \endfirsthead 

  \bicaption[不同模型基于区块2至区块6预测未来1年最大震级的拟合指标效果（数据集划分比例为0.8：0.2）（续）]{不同模型基于区块2至区块6预测未来1年最大震级的拟合指标效果（数据集划分比例为0.8：0.2）（续）。}{The metrics for predicting the maximum magnitute from block 2 to block 6 with the split ratio 0.8:0.2 in next year by different models (continued).} \\
  \toprule
  \multirow{2}*{区块号} & \multirow{2}*{模型} & \multicolumn{2}{c}{训练集} & \multicolumn{2}{c}{测试集} \\
  \cmidrule(lr){3-4} \cmidrule(lr){5-6} \noalign{\smallskip}
  & & MSE & RMSE & MSE & RMSE \\
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \bicaption[不同模型基于区块2预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）]{不同模型基于区块2预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）。}{The time series of predicting the maximum magnitute of block 2 with the split ratio 0.8:0.2 in next year by different models.}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \bicaption[不同模型基于区块3预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）]{不同模型基于区块3预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）。}{The time series of predicting the maximum magnitute of block 3 with the split ratio 0.8:0.2 in next year by different models.}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \bicaption[不同模型基于区块4预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）]{不同模型基于区块4预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）。}{The time series of predicting the maximum magnitute of block 4 with the split ratio 0.8:0.2 in next year by different models.}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \bicaption[不同模型基于区块5预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）]{不同模型基于区块5预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）。}{The time series of predicting the maximum magnitute of block 5 with the split ratio 0.8:0.2 in next year by different models.}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \bicaption[不同模型基于区块6预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）]{不同模型基于区块6预测未来1年最大震级的时间序列图（数据集划分比例为0.8：0.2）。}{The time series of predicting the maximum magnitute of block 6 with the split ratio 0.8:0.2 in next year by different models.}
