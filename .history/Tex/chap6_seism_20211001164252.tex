...
M_{\mathrm{max}}^{\txt{loc}}(t-\Delta)
\mathrm{frequency}^{\txt{loc}}(t-\Delta)
M_{\mathrm{mean}}^{\txt{loc}}(t-\Delta)
b_{\mathrm{lstsq}}^{\txt{loc}}(t-\Delta)
b_{\mathrm{mle}}^{\txt{loc}}(t-\Delta)
a_{\mathrm{lstsq}}^{\txt{loc}}(t-\Delta)
\Delta^{\txt{loc}}M(t-\Delta)
\eta^{\txt{loc}}(t-\Delta)
\sqrt{E}^{\txt{loc}}(t-\Delta)
\mathrm{Lat}_{\mathrm{mean}}^{\txt{loc}}(t-\Delta)
\mathrm{RMSE}_{\mathrm{Lat}}^{\txt{loc}}(t-\Delta)
\mathrm{Lon}_{\mathrm{mean}}^{\txt{loc}}(t-\Delta)
\mathrm{RMSE}_{\mathrm{Lon}}^{\txt{loc}}(t-\Delta)
\mathrm{Lat}_{\sqrt{E}}^{\txt{loc}}(t-\Delta)
\mathrm{Lon}_{\sqrt{E}}^{\txt{loc}}(t-\Delta)
k^{\txt{loc}}(t-\Delta)
M_{\mathrm{future}}^{\txt{loc}}(t-\Delta)

    M^{\mathrm{future}(t+T)=F[P_1(t-\Delta t),P_2(t-\Delta t),\ldots,P_9(t-\Delta t);\ldots;\\
    P_1(t-n\Delta t),P_2(t-n\Delta t),\ldots,P_9(t-n\Delta t);\\
    Q(t-\Delta t),Q(t-2\Delta t),\ldots,Q(t-m\Delta t)].
  \end{split}
\end{equation}
其中，$\Delta t$代表样本的采样间隔，本研究中的采样间隔为1个月。$m=n$，即假设输入的降雨量和泉流量滞后时间相等。$Q(t,t+1,\ldots,t+T)$代表预测未来$T$个月的泉流量。$P_e(t-i\Delta t)(i\in\{1,2,\ldots,n\},e\in\{1,2,\ldots,9\})$代表历史第$e$区域第$i$个月的降雨量，$Q(t-j\Delta t)(j\in\{1,2,\ldots,m\})$代表历史第$j$个月的泉流量。
