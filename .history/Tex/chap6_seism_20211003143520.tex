...
\begin{table}[!htbp]
  \bicaption{不同模型预测整个区块未来一年最大震级的拟合指标效果（数据集划分比例为0.8:0.2）。}{The metrics for predicting the maximum magnitute with the split ratio 0.8:0.2 in next year by different models.}
