...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ccccc}
    ...
    & & MSE & RMSE\\
    \midrule 
    3 & 72-[64(LSTM)-32(Conv)]-72 & \textbf{0.0031} & \textbf{0.0554} \\
      & 132-[32]-72 & 0.0032 & 0.0568 \\
      & 264-[32]-72 & 0.0034 & 0.0584 \\
    \hline
    4 & 72-[32]-72 & \textbf{0.0041} & \textbf{0.0640} \\
      & 132-[32]-72 & 0.0042 & 0.0647 \\
      & 264-[32]-72 & 0.0043 & 0.0658 \\
    \hline
    5 & 72-[64-32-16]-72 & \textbf{0.0030} & \textbf{0.547} \\
      & 132-[64-32-16]-72 & 0.0034 & 0.0581 \\
      & 264-[64-32-16]-72 & 0.0035 & 0.0594 \\
    \bottomrule
  \end{tabular}
\end{table}
