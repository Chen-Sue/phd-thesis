...
\begin{enumerate}
  \item[(1)] 与第24太阳周相比，第25太阳周太阳黑子活动更剧烈。例如，\citet{mcintosh2020overlapping}基于磁活动周期的物理模型，预测到第25太阳周是有史以来观察到的最剧烈的太阳黑子活动，峰值为$\sim$233；\citet{pesnell2018effects}采用na{\"\i}ve方法，得到第25太阳周的太阳黑子数为$\sim$180\pm 60。
