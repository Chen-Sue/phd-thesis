...
\begin{table}[!htbp]
    \centering
    \bicaption{不同模型、不同输入窗口预测未来一个月太阳黑子数量的测试集效果指标。}{The indicators of testing set for predicting sunspot numbers by different models with different input windows.}
    ...
    \begin{tabular}{ccccc}
      ...
      \hline
    %   LSTM-1DCNN & 72-[32-16]-1 & \textbf{0.0041} & \textbf{0.0640} \\
  ...
  \begin{table}[!htbp]
    \centering
    \bicaption{不同模型、不同输入窗口预测未来一个月太阳黑子面积的测试集效果指标。}{The indicators of testing set for predicting sunspot areas by different models with different input windows.}
    ...
    \begin{tabular}{ccccc}
      ...
      \hline
      LSTM-1DCNN & 72-[32-16]-1 & 0.0148 & 0.1216 \\
      LSTM-1DCNN & 132-[32-16]-1 & 0.0151 & 0.1227 \\
      LSTM-1DCNN & 264-[64-32-16]-1 & & \\
      \bottomrule
    \end{tabular}
  \end{table}
...
\begin{table}[!htbp]
    \centering
    \bicaption{不同模型、不同输入窗口预测未来72个月太阳黑子数量的测试集效果指标。}{The indicators of testing set for predicting the next 72 monthly sunspot numbers by different models with different input windows.}
