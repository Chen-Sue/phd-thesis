...
\begin{table}[!htbp]
    \centering
    \bicaption{不同模型、不同输入窗口预测未来一个月太阳黑子强度的测试集效果指标。}{The indicators of testing set for predicting sunspot amplitudes by different models with different input windows.
        Solar minimum and maximum timings and amplitudes of sunspot numbers.}
    \label{tab:ss_max_min}
    \footnotesize
    \renewcommand{\arraystretch}{1}
    \begin{tabular}{cccccccc}
