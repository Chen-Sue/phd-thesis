...
\begin{table}[!htbp]
  ...
  \begin{tabular}{llcccc}
    \toprule
    \multirow{2}*{模型} & \multicolumn{2}{c}{训练集} & \multicolumn{2}{c}{验证集} & \multirow{2}*{96-[节点数]-1}\\
    ...
    KN & \textbf{0.0000} & \textbf{0.0000} & 0.1080 & 0.3286 & \\
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}[b]{0.4\textwidth}
      \caption{$\log N=a-bM$}
      \includegraphics[width=\textwidth]{Img/chap6_seism/block1/seism_lr_minyear_1932_maxyear_2021_spanlat_2_spanlon_4_timewindow_72_nextmonth_12_minmag_3.pdf}
      \label{fig:seism_lr_minyear_1932_maxyear_2021_spanlat_2_spanlon_4_timewindow_72_nextmonth_12_minmag_3}
  \end{subfigure}
  \vspace{-1cm}
  ...
  \label{fig:seism_minyear_1932_maxyear_2021_spanlat_2_spanlon_4_timewindow_72_nextmonth_12_minmag_3}
\end{figure}
