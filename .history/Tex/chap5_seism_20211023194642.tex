...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \bicaption[不同模型预测整个区块未来10年最大震级范围的时间序列图（数据集划分比例为0.8：0.2）]{不同模型预测整个区块未来10年最大震级范围的时间序列图（数据集划分比例为0.8：0.2）。}{The time series of predicting the maximum magnitute with the split ratio 0.8:0.2 in next ten years by different models.}
