...
\begin{sidewaystable}[htpb]
  ...
  5 & $b_{\mathrm{mle}}$ & $\displaystyle b_{\mathrm{mle}}=\frac{\mathrm{log}e}{M_{\mathrm{mean}}-M_C}$ & Gutenberg-Richter法则 $b$-value calculated by the maximum likelihood estimation method. \\ 
