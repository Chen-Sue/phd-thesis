...
\end{equation}
其中，$\Delta t$代表样本的采样间隔，本研究中将采样间隔设为1个月。$S(t,t+\Delta,\ldots,t+\Delta T)$代表预测未来$T$个月的太阳黑子强度。$P_e(t-i\Delta t)(i\in\{1,2,\ldots,n\},e\in\{1,2,\ldots,9\})$代表过去第$e$区域第$i$个月的降雨量，$Q(t-j\Delta t)(j\in\{1,2,\ldots,m\})$代表过去第$j$个月的泉流量。
