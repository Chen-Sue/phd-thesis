...
\begin{table}[!htbp]
  ...
  \begin{tabular}{llcccc}
    \toprule
    \multirow{2}*{模型} & \multirow{2}*{96-[节点数]-1} & \multicolumn{2}{c}{训练集} & \multicolumn{2}{c}{验证集}\\
    \cmidrule(lr){3-4} \cmidrule(lr){5-6} \noalign{\smallskip}
    & & MSE & RMSE & MSE & RMSE\\
    \midrule
    LSTM & 96-[32]-1 & 0.0053 & 0.0731 & 0.1138 & 0.3374  \\
    & 96-[64]-1 & 0.0050 & 0.0708 & 0.0620 & \textbf{0.2490} \\
    & 96-[128]-1 & 0.0097 & 0.0984 & 0.0913 & 0.3022
    \\ \hline
