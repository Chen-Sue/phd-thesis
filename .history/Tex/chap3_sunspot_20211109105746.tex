...
\begin{enumerate}
  ...
  \item[(3)] 与第24太阳周相比，第25太阳周太阳黑子更弱。例如，\citet{kitiashvili2020application}使用同步磁图发现第25太阳周的最大太阳黑子数为$\sim$50（发生在2024年或2025年）。该数值少于Dalton最低点期间的太阳黑子数，可能与Maunder最低点相当。
\end{enumerate}
