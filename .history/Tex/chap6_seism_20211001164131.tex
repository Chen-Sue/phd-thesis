...
\begin{equation}
  ...
  \begin{split}
    ...
    M_{\mathrm{max}}(t-\Delta)
\mathrm{frequency}(t-\Delta)
M_{\mathrm{mean}}(t-\Delta)
b_{\mathrm{lstsq}}(t-\Delta)
b_{\mathrm{mle}}(t-\Delta)
a_{\mathrm{lstsq}}(t-\Delta)
\Delta M(t-\Delta)
\eta(t-\Delta)
\sqrt{E}(t-\Delta)
\mathrm{Lat}_{\mathrm{mean}}(t-\Delta)
\mathrm{RMSE}_{\mathrm{Lat}}(t-\Delta)
\mathrm{Lon}_{\mathrm{mean}}(t-\Delta)
\mathrm{RMSE}_{\mathrm{Lon}}(t-\Delta)
\mathrm{Lat}_{\sqrt{E}}(t-\Delta)
\mathrm{Lon}_{\sqrt{E}}(t-\Delta)
k(t-\Delta)
M_{\mathrm{future}}(t-\Delta)
