...
\begin{table}[!htbp]
    \centering
    \bicaption{不同模型、不同输入窗口预测未来一个月太阳黑子数量的测试集效果指标。}{The indicators of testing set for predicting sunspot amplitudes by different models with different input windows.}
