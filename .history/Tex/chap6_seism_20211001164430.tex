...
\begin{equation}
  ...
  M^{\mathrm{future}(t+T)=
  \begin{split}
    [M_{\mathrm{max}}^{\txt{loc}}(t-\Delta),\mathrm{frequency}^{\txt{loc}}(t-\Delta),M_{\mathrm{mean}}^{\txt{loc}}(t-\Delta),b_{\mathrm{lstsq}}^{\txt{loc}}(t-\Delta),b_{\mathrm{mle}}^{\txt{loc}}(t-\Delta),a_{\mathrm{lstsq}}^{\txt{loc}}(t-\Delta),\\
    \Delta^{\txt{loc}}M(t-\Delta),\eta^{\txt{loc}}(t-\Delta),\sqrt{E}^{\txt{loc}}(t-\Delta),\mathrm{Lat}_{\mathrm{mean}}^{\txt{loc}}(t-\Delta),\mathrm{RMSE}_{\mathrm{Lat}}^{\txt{loc}}(t-\Delta),\\
    \mathrm{Lon}_{\mathrm{mean}}^{\txt{loc}}(t-\Delta),\mathrm{RMSE}_{\mathrm{Lon}}^{\txt{loc}}(t-\Delta),\mathrm{Lat}_{\sqrt{E}}^{\txt{loc}}(t-\Delta),\mathrm{Lon}_{\sqrt{E}}^{\txt{loc}}(t-\Delta),k^{\txt{loc}}(t-\Delta),M_{\mathrm{future}}^{\txt{loc}}(t-\Delta)]
  \end{split}
\end{equation}
