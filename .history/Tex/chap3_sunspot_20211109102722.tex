...
太阳黑子是太阳局部强磁场活动在太阳光球层上产生的黑色斑块，是太阳活动强弱的很容易观测到的特征。太阳黑子位于太阳表面的强磁场区，是太阳表面的炽热气体形成的巨大漩涡，温度高达3000$^{\circ}$C-4500$^{\circ}$C。太阳黑子由太阳大气中的电磁过程引起，时烈时弱，平均以$\sim$11年为周期。通常太阳黑子数量越多，太阳活动越频繁。太阳黑子出现在太阳光球上的黑暗区域，肉眼可见。太阳黑子可以成群出现，也可以是单个孤立的本影，周围有半影。本影是一个黑暗的中心区域，而半影是一个不太黑暗的区域。太阳黑子的产生是因为在太阳内部产生的强磁场，\citet{noyes2013sun}详细阐述了太阳黑子的产生机制。
