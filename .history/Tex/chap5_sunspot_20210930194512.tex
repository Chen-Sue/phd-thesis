...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ccccc}
    ...
    & & MSE & RMSE\\
    \midrule 
    3 & 72-[32(LSTM)-16(Conv)]-72 & 0.0023 & 0.0479 \\ 
    ...
    4 & 72-[64(LSTM)-32(LSTM)-16(Conv)]-72 &  &  \\
      ...
      & 132-[256(LSTM)-128(LSTM)-64(Conv)]-72 &  &  \\
      & 264-[64(LSTM)-32(LSTM)-16(Conv)]-72 &  &  \\
      & 264-[128(LSTM)-64(LSTM)-32(Conv)]-72 &  &  \\
      & 264-[256(LSTM)-128(LSTM)-64(Conv)]-72 &  &  \\
    \hline
    5 & 72-[128(LSTM)-64(LSTM)-32(LSTM)-21(Conv)]-72 &  &  \\
      & 72-[256(LSTM)-128(LSTM)-64(LSTM)-42(Conv)]-72 &  &  \\
      & 72-[512(LSTM)-256(LSTM)-128(LSTM)-85(Conv)]-72 &  &  \\
      & 132-[128(LSTM)-64(LSTM)-32(LSTM)-21(Conv)]-72 & &  \\
      & 132-[256(LSTM)-128(LSTM)-64(LSTM)-42(Conv)]-72 &  &  \\
      & 132-[512(LSTM)-256(LSTM)-128(LSTM)-85(Conv)]-72 &  & \\
      & 264-[128(LSTM)-64(LSTM)-32(LSTM)-21(Conv)]-72 &  &  \\
      & 264-[256(LSTM)-128(LSTM)-64(LSTM)-42(Conv)]-72 &  &  \\
      & 264-[512(LSTM)-256(LSTM)-128(LSTM)-85(Conv)]-72 &  &  \\
    \bottomrule
\end{tabular}
\end{table}
