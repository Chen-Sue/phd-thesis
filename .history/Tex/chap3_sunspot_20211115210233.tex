...
尽管很多学者利用不同的模型预测第25太阳周的峰值，却没有得出统一的结论。对于第23太阳周而言，峰值出现时间为2001年9月，太阳黑子数为238.2，太阳黑子面积为2171.7；对于第24太阳周而言，峰值出现时间为2014年2月，太阳黑子数为146.1，太阳黑子面积为1439.8。对于预测的第25太阳周太阳黑子活动，可分为以下几种结论：
\begin{enumerate}
