...
\begin{itemize}
  \item \textbf{地球大气层}。地球大气层在太阳辐射的紫外线、X射线等作用下形成电离层，无线电通讯的无线电波就是靠电离层的反射向远距离传播的。当太阳活动剧烈，特别是耀斑爆发时，在向阳的半球，太阳射来的强X射线、紫外线等，使电离层D层变厚，造成靠D层反射的长波增强，而靠E层、F层反射的短波却在穿过时被D层强烈吸收受到衰减甚至中断。
  \item \textbf{地球气候}。
  \item \textbf{地球磁场}。
  \item \textbf{航天活动}。
\end{itemize}
