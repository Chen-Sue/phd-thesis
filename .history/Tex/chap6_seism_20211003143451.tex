...
\begin{table}[!htbp]
  \bicaption{不同模型预测区块1未来一年最大震级的拟合指标效果。}{The metrics for predicting the maximum magnitute of block 1 with the split ratio 0.8:0.2 in next year by different models.}
